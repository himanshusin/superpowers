...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user references "Memini Skill Creator", "AntiGravity Skills Creator", or wants to create a new skill.
---
